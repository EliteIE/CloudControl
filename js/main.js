...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeModalElements(); // Garante que os elementos do modal sejam inicializados
    setupEventListeners();     // Configura todos os outros event listeners
...
function initializeModalElements() {
    ...
    // A configuração dos event listeners do modal é feita em setupModalEventListeners
    // que é chamada por setupEventListeners.
    // Se productModal existir, setupModalEventListeners será chamada.
}

// === FUNÇÕES DE MODAL DE PRODUTOS (Definidas antes de serem usadas) ===
...
function setupEventListeners() {
    ...
    // A chamada para setupModalEventListeners foi movida para ser condicional
    // dentro de initializeModalElements ou aqui, após os elementos serem garantidos.
